...
export const CommissionWithdrawController = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
  try {
    ...
    data.typeCommission = Number(params.typeCommission);
