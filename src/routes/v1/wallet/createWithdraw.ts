import { CreateWithdrawController } from '@src/controllers/wallet/WalletController';
 ...
 *    }
 */
export default (route: Router) => route.post('/withdraw/create', CreateWithdrawController);
