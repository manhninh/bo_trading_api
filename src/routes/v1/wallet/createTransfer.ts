import { CreateTransferController } from '@src/controllers/wallet/WalletController';
 ...
 *    }
 */
export default (route: Router) => route.post('/transfer/create', CreateTransferController);
